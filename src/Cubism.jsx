...
export function Cubism(props) {
  ...
  // Filter paintings by category name "Cubism"
  const cubismPaintings = paintings.filter((painting) => painting.categories[0]?.name === "Cubism");
